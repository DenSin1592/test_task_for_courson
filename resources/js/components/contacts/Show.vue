            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <input v-model="name" id="name" class="form-control"
                           placeholder="Name" name="name" required autocomplete="name" autofocus disabled>
                </div>
            </div>
                ...
                <div class=" col-md-6">
                    <div class="list-group">
                        <label class="list-group-item d-flex gap-3">
                            ...
                            <input v-model="favorite" name="favorite" class="form-check-input flex-shrink-0" type="checkbox" style="font-size: 1.375em;" disabled>
